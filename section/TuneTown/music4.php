...
<head>
  ...
  <style>
    ...
    #time-display {
      ...
      font-weight: bold;
      color: white;
      /* Or whatever color fits your header */
    }
...
<body>
  ...
  <main class="grid">
    <div class="video-card" data-video-id="mXMofxtDPUQ">
    <div class="thumb" style="background-image:url('thumbnail/4/days_ofthe_week.jpg');"></div>
    <div class="play-btn"></div>
    <div class="title">Days of the Week Song</div>
    </div>
    <div class="video-card" data-video-id="ZHAqT4hXnMw">
      <div class="thumb" style="background-image:url('thumbnail/4/solarsystem.jpg');"></div>
      <div class="play-btn"></div>
      <div class="title">The Solar System Song</div>
    </div>
    <div class="video-card" data-video-id="f9vIk_DvljU">
      <div class="thumb" style="background-image:url('thumbnail/4/sportssong.jpg');"></div>
      <div class="play-btn"></div>
      <div class="title">Hey-O We Want To Play-O</div>
    </div>
    <div class="video-card" data-video-id="5-DeiXPJ3H8">
      <div class="thumb" style="background-image:url('thumbnail/4/transportation.jpg');"></div>
      <div class="play-btn"></div>
      <div class="title">Transportation Song</div>
    </div>
  </main>
  ...
  <script>
    // Your existing code here is correct for this page
